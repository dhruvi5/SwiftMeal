...
const About = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-center my-9 text-5xl">
        What’s In Store For The Future?
      </h1>

      <h4 className="text-center text-xl mx-20 my-10">
        Food Studio has grand plans to be India’s most loved hyperlocal player.
