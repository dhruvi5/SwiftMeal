...
const restaurantList = [
            ...
            },
            {
              ...
              data: {
                ...
                cloudinaryImageId: "fwchipq6lqkzocwthllh",
            ...
            },
            {
              ...
              data: {
                ...
                cloudinaryImageId: "ifpwhpaniv4tnzfvgeua",
                cuisines: ["Ice Cream"],
                tags: [],
                costForTwo: 25000,
            ...
            },
            {
              ...
              data: {
                ...
                area: "Nanpura",
                totalRatingsString: "100+ ratings",
                cloudinaryImageId: "d21i60aoezenokudd67r",
            ...
            },
            {
              ...
              data: {
                ...
                cloudinaryImageId: "2a12e393b6f22ff805a3fcae6722f866",
                cuisines: ["Pizzas"],
                tags: [],
                costForTwo: 30000,
            ...
            },
            {
              ...
              data: {
                ...
                area: "Piplod",
                totalRatingsString: "100+ ratings",
                cloudinaryImageId: "ea7ba594c7d77cb752de9a730fbcb3bf",
            ...
            },
            {
              ...
              data: {
                ...
                area: "Adajan Patiya",
                totalRatingsString: "1000+ ratings",
                cloudinaryImageId: "6e9c7dac2d1d51926bbd3a035d31e7c5",
                cuisines: [
                  "Biryani",
                  "Mughlai",
                  "Lucknowi",
    ...
    return(
        <div className="body">
            ...
            <div className='res-cont'>
                {/* <Res_card resName="EMERALD" cuisine="CHINESE"  stars="4.4"  /> used for ,ethod 1,2,3*/ } 
                {/* <Res_card  resData={restaurantList[0]} />
                <Res_card  resData={restaurantList[1]} />
                <Res_card  resData={restaurantList[2]} />
                <Res_card  resData={restaurantList[3]} /> */}

                {
                  restaurantList.map(restaurant => <Res_card key="restaurant.data.id" resData={restaurant}/>)
                }
...
//Method 2
// const Res_card = ({resName ,cuisine,stars}) =>{   //destructuring on the fly
...
//     const {resName ,cuisine, stars} = props;
//     return(
//         <div className='res-card '  style={styleCard}>
//             <img className="noodles"   src='https://i.pinimg.com/564x/22/92/10/229210e7999a58a67afc0c4577bdda7d.jpg'/>
//             {/* <h3 className='res-name'>{resName}</h3>
...
const Res_card = (props) =>{   //destructuring on the fly
    ...
    return(
        <div className='res-card '  style={styleCard}>
            {/* <img className="noodles"   src={'https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/' + resData.data.cloudinaryImageId}/> //CLOUDIMAGINARY IS NOT AVAILABLE FOR SWIGGY ANY MORE*/}
